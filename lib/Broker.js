    ...
    self.ctrl.rget(rid, function (err, req) {
      ...
      if (type == MDP.W_REPLY_REJECT) {
        ...
        self.ctrl.rset(rid, req, function() {
          self.ctrl.runshift(worker.service, req, function() {
            delete worker.rid;
...
Broker.prototype.requestQueue = function(srvName, msg) {
  ...
  var rhash = crypto.createHash('sha1')
  ...
  async.auto({
    ...
    process: ['cache', function(next, res) {
      ...
      function(next) {
        self.ctrl.rpush(srvName, req, next);
      },
      function(next) {
  ...
  var handle = function(workerId, worker, next) {
    self.ctrl.rpop(srvName, function(err, req) {
      ...
      if (req.rejects.indexOf(workerId) !== -1) {
        self.ctrl.runshift(srvName, req, next);
        return;
      }
...
Controller.prototype.rpush = function(srv, req, callback) {
  if (!this.srq[srv]) {
    this.srq[srv] = [];
  }
...
Controller.prototype.runshift = function(srv, req, callback) {
  if (!this.srq[srv]) {
    this.srq[srv] = [];
  }
